...
const Header = ({ title }) => {
  ...
  return (
    <header className="sticky top-0 z-40 w-full px-8 py-4 bg-white/10 backdrop-blur-sm border-b border-gray-200 flex justify-between items-center transition-all duration-300">
      {/* جهة اليمين: العنوان */}
      <motion.div
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3 bg-gray-500/5 p-2 pr-4 rounded-2xl border border-gray-100">
          ...
          <div className="w-12 h-12 bg-linear-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center text-white font-bold shadow-lg shadow-blue-200">
